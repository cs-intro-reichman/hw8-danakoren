...
public class Network {
    ...
    *  Otherwise, creates a new user with the given name, adds the user to this network, and returns true. */
    ...
    public String recommendWhoToFollow(String name) {
        //// Replace the following statement with your code
        User recommendedUser = this.getUser(name);
        int maxMutual = 0;
        String user = "";
        ...
        for (int i = 0; i < users.length; i++) {
            ...
            if (recommendedUser.countMutual(this.users[i]) > maxMutual){
                maxMutual = recommendedUser.countMutual(this.users[i]);
                user = this.users[i].getName();
            }
    ...
    public String toString() {
       ...
       String des = "Network:\n";
        ...
        for (int i = 0; i < userCount - 1; i++) {
            des += users[i].toString() + "\n";
        }
        des += users[userCount - 1];
       return des;
    }
}
